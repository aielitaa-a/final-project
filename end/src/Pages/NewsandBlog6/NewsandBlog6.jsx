...
import './NewsandBlog6'
import vegblog6 from '../../assets/vagnews.png'

function NewsandBlog6() {
  return (
    <div className='blog4'>
      <div className="blogg4">
        <img className='tomatoblog4' src={vegblog6} alt="" />
        <div className="blockblog4">
          <div className="block-blog4">
            ...
            <div className="bottom-date4">
              <h1 className='Need-to-Know4'>Super Food You Should Eat Freshly</h1>
      ...
      <div className="bottom-head4">
        <p className='Uniquely4'> Uniquely matrix economically sound value through cooperative technology. Competently parallel task fully <br />
        ...
        <h1 className='for-all-people4'> Organic product for all peoples </h1>
        <p className='Appropriately4'> Appropriately empower dynamic leadership skills after business portals. Globally my coordinate interactive <br />
        ...
        <h1 className='make-perfect4'> Make perfect organic product with us </h1>
        <p className='Collaboratively4'> Collaboratively administrate empowered markets via plug-and-play networks. <br />
