...
import './NewsandBlog3.css'
import leavblog from '../../assets/leavs.png'

function NewsandBlog3() {
  return (
    <div className='blog3'>
      <div className="blogg3">
        <img className='leavsblog3' src={leavblog} alt="" />
        <div className="blockblog3">
          <div className="block-blog3">
            <div className="dateblog3">
              <h4> Posted On: </h4>
              <h4> September 2, 2025 </h4>
            </div>
            <div className="bottom-date3">
              <h1 className='Need-to-Know'> Organic Fruits: Surprising Benefits and Facts </h1>
